...
/// Positions a window in the upper-left corner of the screen.
///
...
class UpperLeftCalculation: WindowCalculation, RepeatedExecutionsInThirdsCalculation {
    ...
    /// Positions the window in the upper-left with the given width fraction.
    ///
    ...
    func calculateFractionalRect(_ params: RectCalculationParameters, fraction: Float) -> RectResult {
        ...
        // Position: left edge, top half (macOS y=0 is at bottom, so top = maxY - height)
