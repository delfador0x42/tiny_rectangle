...
```bash
defaults write com.knollsoft.tiny_window_manager alternateDefaultShortcuts -bool true
```
...
```bash
defaults write com.knollsoft.tiny_window_manager subsequentExecutionMode -int 2
```
...
2: disabled
3: cycle displays for left/right actions, halves to thirds for the rest (old tiny_window_manager behavior)
...
```bash
defaults write com.knollsoft.tiny_window_manager centerHalfCycles -int 1
```
...
```bash
defaults write com.knollsoft.tiny_window_manager resizeOnDirectionalMove -bool true
```
...
```bash
defaults write com.knollsoft.tiny_window_manager stageSize -float <VALUE>
```

To set it to a proportion of your screen's width, set it to a value between 0 and 1.

```bash
defaults write com.knollsoft.tiny_window_manager stageSize -float <VALUE_BETWEEN_0_AND_1>
```

## Enable Todo Mode

See the [wiki](https://github.com/rxhanson/tiny_window_manager/wiki/Todo-Mode) for more info.

```bash
defaults write com.knollsoft.tiny_window_manager todo -int 1
```
...
```bash
defaults write com.knollsoft.tiny_window_manager snapModifiers -int 1048576
```
...
```bash
defaults write com.knollsoft.tiny_window_manager almostMaximizeHeight -float <VALUE_BETWEEN_0_&_1>
```

```bash
defaults write com.knollsoft.tiny_window_manager almostMaximizeWidth -float <VALUE_BETWEEN_0_&_1>
```
...
```bash
defaults write com.knollsoft.tiny_window_manager specified -dict-add keyCode -float 8 modifierFlags -float 1966080
```

```bash
defaults write com.knollsoft.tiny_window_manager specifiedHeight -float 1050
defaults write com.knollsoft.tiny_window_manager specifiedWidth -float 1680
```
...
```bash
defaults write com.knollsoft.tiny_window_manager centerProminently -dict-add keyCode -float 8 modifierFlags -float 1835305
```
...
```bash
defaults write com.knollsoft.tiny_window_manager topLeftNinth -dict-add keyCode -float 18 modifierFlags -float 917504
```
...
```bash
defaults write com.knollsoft.tiny_window_manager topLeftEighth -dict-add keyCode -float 18 modifierFlags -float 917504
```
...
```bash
defaults write com.knollsoft.tiny_window_manager topLeftThird -dict-add keyCode -float 18 modifierFlags -float 917504
```
...
```bash
defaults write com.knollsoft.tiny_window_manager doubleWidthRight -dict-add keyCode -float 124 modifierFlags -float 11403555
```
...
```bash
defaults write com.knollsoft.tiny_window_manager cascadeActiveApp -dict-add keyCode -float 2 modifierFlags -float 393475
```
...
```bash
defaults write com.knollsoft.tiny_window_manager footprintAlpha -float <VALUE_BETWEEN_0_&_1>
```

Change the border width. Default is 2 (used to be 1).

```bash
defaults write com.knollsoft.tiny_window_manager footprintBorderWidth -float <NUM_PIXELS>
```

Disable the fade.

```bash
defaults write com.knollsoft.tiny_window_manager footprintFade -int 2
```

Change the color.

```bash
defaults write com.knollsoft.tiny_window_manager footprintColor -string "{\"red\":0,\"blue\":0.5,\"green\":0.5}"
```

Change the animation duration. The value is a multiplier. Default is 0 (no animation).

```bash
defaults write com.knollsoft.tiny_window_manager footprintAnimationDurationMultiplier -float <MULTIPLIER>
```
...
```bash
defaults write com.knollsoft.tiny_window_manager centeredDirectionalMove -int 2
```
...
```bash
defaults write com.knollsoft.tiny_window_manager minimumWindowWidth -float <VALUE_BETWEEN_0_&_1>
```

```bash
defaults write com.knollsoft.tiny_window_manager minimumWindowHeight -float <VALUE_BETWEEN_0_&_1>
```
...
```bash
defaults write com.knollsoft.tiny_window_manager sizeOffset -float <NUM_PIXELS>
```
...
```bash
defaults write com.knollsoft.tiny_window_manager curtainChangeSize -int 2
```
...
```bash
defaults write com.knollsoft.tiny_window_manager largerWidth -dict-add keyCode -float 30 modifierFlags -float 786432
defaults write com.knollsoft.tiny_window_manager smallerWidth -dict-add keyCode -float 33 modifierFlags -float 786432
```
...
```bash
defaults write com.knollsoft.tiny_window_manager largerHeight -dict-add keyCode -float 30 modifierFlags -float 917504
defaults write com.knollsoft.tiny_window_manager smallerHeight -dict-add keyCode -float 33 modifierFlags -float 917504
```

## Disabling window restore when moving windows

```bash
defaults write com.knollsoft.tiny_window_manager unsnapRestore -int 2
```
...
```bash
defaults write com.knollsoft.tiny_window_manager snapEdgeMarginTop -int 10
defaults write com.knollsoft.tiny_window_manager snapEdgeMarginBottom -int 10
defaults write com.knollsoft.tiny_window_manager snapEdgeMarginLeft -int 10
defaults write com.knollsoft.tiny_window_manager snapEdgeMarginRight -int 10
```
...
```bash
defaults write com.knollsoft.tiny_window_manager screenEdgeGapTop -int 10
defaults write com.knollsoft.tiny_window_manager screenEdgeGapBottom -int 10
defaults write com.knollsoft.tiny_window_manager screenEdgeGapLeft -int 10
defaults write com.knollsoft.tiny_window_manager screenEdgeGapRight -int 10
```
...
```bash
defaults write com.knollsoft.tiny_window_manager screenEdgeGapTopNotch -int 5
```
...
```bash
defaults write com.knollsoft.tiny_window_manager screenEdgeGapsOnMainScreenOnly -bool true
```
...
```bash
defaults write com.knollsoft.tiny_window_manager ignoredSnapAreas -int 1
```

To disable the Top Half and Bottom Half snap areas, the bit field would be 1111 0000 0000, or 3840

```bash
defaults write com.knollsoft.tiny_window_manager ignoredSnapAreas -int 3840
```
...
```bash
defaults write com.knollsoft.tiny_window_manager applyGapsToMaximize -int 2
```

To disable the gaps for "Maximize Height", execute:

```bash
defaults write com.knollsoft.tiny_window_manager applyGapsToMaximizeHeight -int 2
```
...
```bash
defaults write com.knollsoft.tiny_window_manager sixthsSnapArea -bool true
```
...
```bash
defaults write com.knollsoft.tiny_window_manager moveCursor -int 1
```
...
```bash
defaults write com.knollsoft.tiny_window_manager missionControlDragging -int 2
```

Change the allowed off-screen distance. The value is in pixels and is tied to the speed. Default is 25.

```bash
defaults write com.knollsoft.tiny_window_manager missionControlDraggingAllowedOffscreenDistance -float <DISTANCE>
```

Change the disallowed duration. The value is in milliseconds. Default is 250.

```bash
defaults write com.knollsoft.tiny_window_manager missionControlDraggingDisallowedDuration -int <DURATION>
```

## Change the behavior of double-click window title bar

To change the action ([list](https://github.com/rxhanson/tiny_window_manager/blob/master/tiny_window_manager/WindowAction.swift)):

```bash
defaults write com.knollsoft.tiny_window_manager doubleClickTitleBar -int <ACTION_ID + 1>
```

To disable restore when double-clicked again:

```bash
defaults write com.knollsoft.tiny_window_manager doubleClickTitleBarRestore -int 2
```

To disable double-click window title bar only for specific bundle ids (in example, Outlook):

```bash
defaults write com.knollsoft.tiny_window_manager doubleClickTitleBarIgnoredApps -string "[\"com.microsoft.Outlook\"]"
```
...
```bash
defaults write com.knollsoft.tiny_window_manager screensOrderedByX -int 1
```
